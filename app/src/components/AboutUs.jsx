...
const AboutUs = () => {
  ...
  return (
    ...
    >
      <div className='container py-5 mx-auto' style={{ maxWidth: '1400px' }}>
        <div className='row align-items-center'>
          <div className="col-12 col-md-6 mb-4 mb-md-0" data-aos="slide-right">
            ...
            <p style={{ wordWrap: 'break-word' }}>
              At CargoExtra, we are committed to making global shipping easy, affordable,
          ...
          <div className="col-12 col-md-6 text-center" data-aos="slide-left">
            <img src={img1} alt="About Us" className="img-fluid" style={{ width: '90%', maxWidth: '100%', height: 'auto' }} />
          </div>
        </div>

        <div className='d-md-flex justify-content-center gap-4'>
          <Card style={{width: '18rem', boxShadow: '0 4px 10px rgba(0,0,0,0.1)' }}>
            <Card.Body>
